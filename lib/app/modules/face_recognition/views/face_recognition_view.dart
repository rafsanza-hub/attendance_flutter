...
//       startImageStream();
//     } catch (e) {
//       AppLogger.instance.e('Error initializing camera: $e');
...
//       } catch (e) {
//         AppLogger.instance.e('Error during detection: $e');
...
//     } catch (e) {
//       AppLogger.instance.e('Error during take picture: $e');
...
//     List<int> nv21Bytes = _convertYUV420ToNV21(image);

//     InputImage inputImage = InputImage.fromBytes(
//       bytes: Uint8List.fromList(nv21Bytes),
//       metadata: InputImageMetadata(
//         size: Size(width.toDouble(), height.toDouble()),
//         rotation: rotation,
//         format: InputImageFormat.nv21,
//         bytesPerRow: yRowStride, // Y plane stride
//       ),
//     );
...
//   int uvSize = (width * height) ~/ 4; // UV plane is 1/4 of Y plane size
//   int totalSize = ySize + uvSize * 2; // Y + UV interleaved

//   var nv21 = Uint8List(totalSize);

//   // Copy Y plane
//   nv21.setRange(0, ySize, yBuffer);

//   // Interleave U and V planes for NV21 (V-U order)
...
//   final int alpha = 0xFF; // Extract alpha value
